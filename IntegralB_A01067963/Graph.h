...
public:
    void loadGraphMat(string, string, string);
    void loadGraphList(string, string, string);
    Graph(int);
    Graph();
...
void Graph::loadGraphMat(string name, string a, string b){
...
void Graph::loadGraphList(string, string a, string b){
